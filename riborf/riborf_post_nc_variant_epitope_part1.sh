...
sort $2/translating_ORF_ID.txt -k1,1d -k2,2n -t '|' > $2/translating_ORF_ID.sorted.txt
sort $3 -k1,1d -k2,2n -t '|' > $2/candidateORF.genepred.sorted.txt
join -t$'\t' $2/translating_ORF_ID.sorted.txt $2/candidateORF.genepred.sorted.txt > $2/translating.candidateORF.genepred.txt
