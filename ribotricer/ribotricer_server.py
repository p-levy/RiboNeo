...
def get_args():
    ...
    parser.add_argument('-f',
                        ...
                        default='/plevy/ref/GRCh38.primary_assembly.genome.fa')

    parser.add_argument('-g',
                        '--gtf',
                        metavar='\b',
                        help='Path to GTF file',
                        default='/plevy/ref/combined.gencode.v39.mitranscriptome.unique_id.min_24nt.v2.unannotated.sorted.gtf')

    parser.add_argument('-c',
                        '--candidate',
                        metavar='\b',
                        help='Path to candidate orf file',
                        default='/plevy/proj/riboseq/ribotricer/ribotricer_candidate_orfs.tsv')
